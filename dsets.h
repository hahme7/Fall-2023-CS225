...
class DisjointSets
{
  // Wasnt in Header already for some reason?
  private:
  ...
  public:
     ...
     * @param elem The index to look at our vector
     ...
     */
     //Function so small and needless to modify that it is best to do it in here
    int size(int elem) { return -(vect_[find(elem)]); }
